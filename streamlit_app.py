...
def load_data():
    ...
    records = sheet.get_all_records(expected_headers=[
        "timestamp", "age", "gender", "shop_freq", "satisfaction", "value_factors",
        "time_saving", "tech_issues", "avoid_online", "avoid_reasons", "barriers",
        "trust_payment", "encouragement", "recommendation", "trust_features", "comments"
    ])
...
if mode == "📋 Take Survey":
    ...
    **University of Malaya**
    ...
    barriers = st.multiselect("Q6. What prevents you from shopping online more often?",
        ["Hidden costs", "Lack of trust", "Long delivery time", "Prefer to see the item", "Poor customer service"])
